...
HACS 可以从标准目录安装集成，也可以使用 GitHub Release 中固定名称的 `rose-home-assistant.zip`。维护者推送与 manifest 版本一致的 tag（例如 `v0.1.0`）后，GitHub Actions 会直接从 `custom_components/rose` 创建 Release 和安装包。
