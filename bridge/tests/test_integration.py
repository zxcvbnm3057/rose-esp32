...
from ..src import IoTAgentClient, EVENT_PORT_STATUS, RESOURCE_GPIO, EventCmdAck, EventError, IOT_ERR_RESOURCE_CONFLICT
...
class TestErrorHandling:
    ...
    def test_timeout_handling(self, client):
        ...
        # The ESP32 sends SIGNAL_CAPTURED even with 0 edges — valid result.
        # Before the fix, empty edges returned None; now correctly returns [].
        assert received is not None and len(received) == 0, \
            "receive_signal should return empty list (capture succeeded, no signal transmitted)"
